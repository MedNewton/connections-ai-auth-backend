...
async function findCreatorByField(field, value) {
...
export async function stripeRoutes(fastify) {
    ...
    // ──────────────────────────────────────────────
    fastify.post("/create-connect-account", async (req, reply) => {
    ...
    // ──────────────────────────────────────────────
    fastify.get("/connect-callback", async (req, reply) => {
    ...
    // ──────────────────────────────────────────────
    fastify.get("/connect-account-status/:userId", async (req, reply) => {
  ...
  background: #F6F6F6; text-align: center; padding: 20px; }                                                                                                            
    ...
    // ──────────────────────────────────────────────
    fastify.post("/delete-customer", { preHandler: requireServiceToken }, async (req, reply) => {
    ...
    fastify.post("/offboard-connect", { preHandler: requireServiceToken }, async (req, reply) => {
        ...
        try {
            ...
            if (stripeAccountId) {
                try {
                    ...
                    req.log.warn({ stripeAccountId, code: err?.code }, "Stripe deauthorize failed, removing Firebase record anyway");
                }
            }
    ...
    fastify.post("/refund", { preHandler: requireServiceToken }, async (req, reply) => {
        ...
        try {
            ...
            req.log.info({ paymentIntentId, refundId: refund.id, status: refund.status }, "Refund created");
...
async function handleAccountUpdated(account, log) {
